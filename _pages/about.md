...
I am a public health professional, disease ecologist, and data scientist with research, lab, and field experience spanning the dimensions of One Health (wildlife, livestock, human, and environmental health):
•	Strong research and science communication experience including 35+ peer-reviewed publications, over $300,000 in grant funding, and engaging with decision makers and public audiences through policy briefs, presentations, and accessible writing. 
•	Expertise in advanced modeling, statistical, and analytical approaches including individual-based, network, machine learning, time series, and ordinary differential equation modeling. 
•	Over ten years of programming experience with fluency in R, version control, reproducibility, and high-performance computing.
